...
impl<'a> H264NalFuANonIDRSlicePacket<'a> {
    ...
    #[allow(trivial_numeric_casts)]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    pub fn get_slice_type(&self) -> u5 {
        let _self = self;
        let co = 0;
        ((_self.packet[co] as u5) & 124) >> 2
    }
    /// Get the pic_parameter_set_id field.
    #[inline]
    #[allow(trivial_numeric_casts)]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    pub fn get_pic_parameter_set_id(&self) -> u1 {
        let _self = self;
        let co = 0;
        ((_self.packet[co] as u1) & 2) >> 1
    }
    /// Get the nop_bit field.
    #[inline]
    #[allow(trivial_numeric_casts)]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    pub fn get_nop_bit(&self) -> u1 {
        let _self = self;
        let co = 0;
        ((_self.packet[co] as u1) & 1)
    }
}
impl<'a> MutableH264NalFuANonIDRSlicePacket<'a> {
    ...
    pub fn populate(&mut self, packet: &H264NalFuANonIDRSlice) {
        ...
        _self.set_pic_parameter_set_id(packet.pic_parameter_set_id);
        _self.set_nop_bit(packet.nop_bit);
    ...
    #[allow(trivial_numeric_casts)]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    pub fn set_slice_type(&mut self, val: u5) {
        let _self = self;
        let co = 0;
        _self.packet[co + 0] = ((_self.packet[co + 0] & 131) | (((val & 31) << 2) as u8)) as u8;
    }
    /// Set the pic_parameter_set_id field.
    #[inline]
    #[allow(trivial_numeric_casts)]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    pub fn set_pic_parameter_set_id(&mut self, val: u1) {
        let _self = self;
        let co = 0;
        _self.packet[co + 0] = ((_self.packet[co + 0] & 253) | (((val & 1) << 1) as u8)) as u8;
    }
    /// Set the nop_bit field.
    #[inline]
    #[allow(trivial_numeric_casts)]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    pub fn set_nop_bit(&mut self, val: u1) {
        let _self = self;
        let co = 0;
        _self.packet[co + 0] = ((_self.packet[co + 0] & 254) | ((val & 1) as u8)) as u8;
    }
...
impl<'p> ::pnet_macros_support::packet::FromPacket for H264NalFuANonIDRSlicePacket<'p> {
    ...
    fn from_packet(&self) -> H264NalFuANonIDRSlice {
        ...
        H264NalFuANonIDRSlice {
            ...
            pic_parameter_set_id: _self.get_pic_parameter_set_id(),
            nop_bit: _self.get_nop_bit(),
            payload: {
...
impl<'p> ::std::fmt::Debug for H264NalFuANonIDRSlicePacket<'p> {
    ...
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let _self = self;
        write!(fmt ,
               "H264NalFuANonIDRSlicePacket {{ first_mb_in_slice : {:?}, slice_type : {:?}, pic_parameter_set_id : {:?}, nop_bit : {:?},  }}"
               , _self . get_first_mb_in_slice (  ) , _self . get_slice_type (
                ) , _self . get_pic_parameter_set_id (  ) , _self .
               get_nop_bit (  ))
    }
}
impl<'p> ::std::fmt::Debug for MutableH264NalFuANonIDRSlicePacket<'p> {
    ...
    fn fmt(&self, fmt: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let _self = self;
        write!(fmt ,
               "MutableH264NalFuANonIDRSlicePacket {{ first_mb_in_slice : {:?}, slice_type : {:?}, pic_parameter_set_id : {:?}, nop_bit : {:?},  }}"
               , _self . get_first_mb_in_slice (  ) , _self . get_slice_type (
                ) , _self . get_pic_parameter_set_id (  ) , _self .
               get_nop_bit (  ))
    }
